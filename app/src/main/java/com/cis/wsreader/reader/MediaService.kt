...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: com.cis.wsreader.MyneApp
            get() = application as com.cis.wsreader.MyneApp
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as com.cis.wsreader.MyneApp).readerRepository
    ...
    companion object {
        ...
        const val SERVICE_INTERFACE = "com.cis.wsreader.reader.MediaService"
